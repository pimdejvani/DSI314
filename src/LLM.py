...
หมวดที่ 8 และ 9 curr_qa ชื่อเกณฑ์ในการประเมิณหลักสูตร อาจอยู่ในทั้ง 8 และ 9 หรืออยู่แค่อย่างละที่ ถ้าอยู่ในหมวด 9 จะอยู่แค่เฉพาะในส่วน ผลการดำเนินงานของหลักสูตร/ผลการประกันคุณภาพการศึกษา ฉันอยากได้แค่ชื่อเกณฑ์และเอาแค่ชื่อย่อ เช่น AACSB, EQUIS, AMBA, AUN-QA, EdPEx, IQA,มาตรฐานของกระทรวงฯ, สกอ., สปอว. (ถ้ามีหลายอันใส่มาแค่ใช้ ,) แต่ที่เป็นพวก มคอ. ไม่เอา
"""
